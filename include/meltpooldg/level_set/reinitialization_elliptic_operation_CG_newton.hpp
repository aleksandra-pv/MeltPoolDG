...
namespace MeltPoolDG::LevelSet
{
  ...
  class ReinitializationEllipticOperationNewton : public ReinitializationOperationBase<dim, number>
  {
  public:
     ...
     */
    ReinitializationEllipticOperationNewton(const ScratchData<dim, dim, number> &scratch_data_in,
  ...
  private:
    ...
    std::unique_ptr<ReinitializationEllipticOperatorNewton<dim, number>> reinit_operator;
    ...
    /// Newton-Raphson solver class for iterative solution of the non-linear system
    NewtonRaphsonSolver<number, VectorType> newton;

    /**
     * @brief Set up and solve the system.
     */
    void
    setup_newton();
  };
