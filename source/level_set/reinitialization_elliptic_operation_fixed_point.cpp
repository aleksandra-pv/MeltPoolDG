...
namespace MeltPoolDG::LevelSet
{
  ...
  {
    const unsigned int max_iterations = reinit_data.elliptic.nlsolve.max_nonlinear_iterations;
    number             tolerance      = reinit_data.elliptic.nlsolve.residual_tolerance;
    unsigned int       iter           = 0;
