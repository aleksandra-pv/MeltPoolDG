...
namespace MeltPoolDG::LevelSet
{
  ...
  ReinitializationEllipticOperatorNewton<dim, number>::ReinitializationEllipticOperatorNewton(
  ...
  template <int dim, typename number>
  void
  ReinitializationEllipticOperatorNewton<dim, number>::vmult(VectorType       &dst,
  ...
  typename ReinitializationEllipticOperatorNewton<dim, number>::VectorizedArrayType
  ReinitializationEllipticOperatorNewton<dim, number>::evaluate_coefficient_derivative(
  ...
  template <int dim, typename number>
  void
  ReinitializationEllipticOperatorNewton<dim, number>::residual_laplace_operation(
  ...
  template <int dim, typename number>
  void
  ReinitializationEllipticOperatorNewton<dim, number>::tangent_laplace_operation(
  ...
  template <int dim, typename number>
  void
  ReinitializationEllipticOperatorNewton<dim, number>::create_residual(
    VectorType       &dst,
  ...
  template <int n_components>
  typename ReinitializationEllipticOperatorNewton<dim, number>::VectorizedArrayType
  ReinitializationEllipticOperatorNewton<dim, number>::evaluate_coefficient(
    const FECellIntegrator<dim, n_components, number> &phi_old,
    const unsigned int                                 q_index) const
  {
    const auto grad_norm = phi_old.get_gradient(q_index).norm();
  ...
  template <int dim, typename number>
  void
  ReinitializationEllipticOperatorNewton<dim, number>::interface_penalty_cell_operation(
  ...
  template <int dim, typename number>
  void
  ReinitializationEllipticOperatorNewton<dim, number>::cell_operation(
    FECellIntegrator<dim, 1, number> &interface_penalty,
    FECellIntegrator<dim, 1, number> &cell_eval,
    PointEvaluationType              &interface_penalty_surface,
  ...
  template <int dim, typename number>
  void
  ReinitializationEllipticOperatorNewton<dim, number>::compute_system_matrix_from_matrixfree(
  ...
  template <int dim, typename number>
  void
  ReinitializationEllipticOperatorNewton<dim, number>::compute_inverse_diagonal_from_matrixfree(
  ...
  template class ReinitializationEllipticOperatorNewton<1, double>;
  template class ReinitializationEllipticOperatorNewton<2, double>;
  template class ReinitializationEllipticOperatorNewton<3, double>;
} // namespace MeltPoolDG::LevelSet
